...
// CONCATENATED MODULE: ./docs/_client/src/js/logEventDetail.js
 ...
 */
class Dialog_Dialog extends Popup_Popup {
  /**
   * Create a Dialog.
   * @constructor
   *
  ...
  init() {
    ...
    if (0 === this.content.length) {
      Object.getPrototypeOf(Popup_Popup).configurationError.call(
        this,
...
class MenuButton_MenuButton extends Popup_Popup {
  ...
  init() {
    ...
    if (null != this.list && 'UL' === this.list.nodeName) {
      this.menu = new Menu_Menu(this.list, { _suppressDispatch });
    } else if ('UL' === this.target.nodeName) {
      // Fallback to the target if it's a UL.
      this.menu = new Menu_Menu(this.target, { _suppressDispatch });
    } else {
      const list = this.target.querySelector('ul');
      this.menu = new Menu_Menu(list, { _suppressDispatch });
    }
...
/***/ })
/******/ ]);
//# sourceMappingURL=global.9baaacfff98a3c64709c.bundle.min.js.map